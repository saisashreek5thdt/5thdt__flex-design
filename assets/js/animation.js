...
const anim_youtube_videos = [
  ...
  { videosrc: "https://www.youtube.com/embed/_Y7sNUddLu4" },
  { videosrc: "https://www.youtube.com/embed/NxyhE-lR53Y" },
  { videosrc: "https://www.youtube.com/embed/u_4f_V7Rllo" },
  { videosrc: "https://www.youtube.com/embed/wUh7Sftopgk" },
  { videosrc: "https://www.youtube.com/embed/tkdWBGHplGs" }
];
...
for (let i = 0; i < anim_youtube_videos.length; i++) {
  ...
  card_video_block.setAttribute("volume", "0");
...
function load_youtube_videos(id) {
  ...
  switch(Id){
    case 0:
      if(Id == 0){
        document.getElementById("youtube_link").src= anim_youtube_videos[0].videosrc;
      }
       break;
    case 1:
      if(Id == 1){
        document.getElementById("youtube_link").src= anim_youtube_videos[1].videosrc;
      }
      break;
    case 2:
      if(Id == 2){
        document.getElementById("youtube_link").src= anim_youtube_videos[2].videosrc;
      }
      break;
    case 3:
      if(Id == 3){
        document.getElementById("youtube_link").src= anim_youtube_videos[3].videosrc;
      }
       break;
    case 4:
      if(Id == 4){
        document.getElementById("youtube_link").src= anim_youtube_videos[4].videosrc;
      }
      break;
    case 5:
      if(Id == 5){
        document.getElementById("youtube_link").src= anim_youtube_videos[5].videosrc;
      }
       break;
    }
